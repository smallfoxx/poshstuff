...
.TAGS 
    Commands Dependencies Module "Dependent Modules"
...
.DESCRIPTION
By searching through content of file(s) in path, finds all the commands
in those files, and the modules that house those commands.
